...
\usepackage{listings}
\usepackage{lastpage}
\usepackage{00-styles/admonitionbox}

% Page style
% ----------
% use this for double-sided printing
% \usepackage[margin=3cm, left=3.5cm, right=3.5cm, twoside=true]{geometry}
\usepackage[margin=2.8cm, left=3cm, right=3cm]{geometry}
\usepackage{fancyhdr}
...
\fancyfoot[L]{\small\Institution~\Year~//\Authors}
\fancyfoot[R]{\small \thepage}
% use for double-sided printing
%\fancyhead[OR]{\bfseries \nouppercase{\rightmark}}
%\fancyhead[EL]{\bfseries \nouppercase{\leftmark}}
%\fancyfoot[ER,OL]{\small\Institution~\Year~//\Authors}
...
\def\cleartoodd{%
	...
	\ifodd\value{page}\else\thispagestyle{empty}\fi%
%	\value{page}%
}
